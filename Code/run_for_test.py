...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../../model/DQN/checkpoint/0921110659_agenthrljoint2_T22_ss100_lr0.0005_RFS66_RFF0_RFNCY0_RFIRS0_RFRA-54_RFRMT-66_mls0_gamma0.95_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_dataLabel_All_RID0/")
...
parser.add_argument("--reward_for_reach_max_turn", dest="reward_for_reach_max_turn", type=float, default=-88)
parser.add_argument("--reward_for_repeated_action", dest='reward_for_repeated_action', type=float, default= -66, help='the reward for repeated action')
...
parser.add_argument("--error_prob", dest="error_prob", type=float, default=0.00, help="Error probability when applying noisy channel?")
