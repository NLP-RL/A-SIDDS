...
class AgentHRL_joint2(object):
    def __init__(self, action_set, slot_set, disease_symptom, parameter):
        ...
        #for model in dirs:
            ...
            print('bb:',temp_parameter[label]["input_size_dqn"])
        ...
        if parameter.get("state_reduced"):
            input_size = (len(self.slot_set)-1) * 4  +2  # the dictionary of slot_set contains a key of "disease" which need to be removed first.
        else:
    ...
    def __master_next(self, state_rep, greedy_strategy):
        ...
        print('greedy Strategy: ',greedy_strategy)
