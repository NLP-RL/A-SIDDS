...
parser.add_argument("--epsilon", dest="epsilon", type=float, default=0.15, help="The greedy probability of DQN")
...
# noisy channel
parser.add_argument("--noisy_channel", dest="noisy_channel", type=boolean_string, default=True, help="noisy channel for user action?")
